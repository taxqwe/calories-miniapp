window.MacroGoalsI18n = {
  ...
  uz: {
    title: "Oqsil/yogʻ/uglevod maqsadlari",
    refLabel: "Hisoblash asosi:",
    refCurrent: "joriy vazn {w} kg",
    refDesired: "maqsadli vazn",
    unitKg: "kg",
    needDesired: "Maqsadli vazningizni kiriting",
    desiredWeightRange: "Maqsadli vazn {min} va {max} kg orasida boʻlishi kerak",
    presets: {
      recommended: "Tavsiya etilgan",
      high_protein: "Oqsili koʻp",
      moderate: "Oʻrtacha",
      custom: "Oʻzingizniki"
    },
    protein: "Oqsil",
    fat: "Yogʻ",
    carbs: "Uglevod",
    formulaCurrent: "joriy vaznning har kilogrammiga gramm",
    formulaDesired: "maqsadli vaznning har kilogrammiga gramm",
    balanceOk: "Hammasi mos",
    balanceOver: "Oqsil/yogʻ/uglevoddan olinadigan kaloriya maqsaddan {n} kkal koʻp",
    balanceUnder: "Oqsil/yogʻ/uglevoddan olinadigan kaloriya maqsaddan {n} kkal kam",
    fitCarbs: "Uglevod bilan tenglashtirish",
    carbsZero: "Oqsil va yogʻdan olinadigan kaloriya maqsadga yetadi — uglevod miqdori nol.",
    auto: "avto",
    unitG: "g",
    unitPerKg: "g/kg",
    zeroForbidden: "0 kiritib boʻlmaydi — maqsadni olib tashlash uchun maydonni tozalang",
    dirLabel: "Yoʻnalish",
    dirAtLeast: "kamida",
    dirAtMost: "koʻpi bilan",
    dirAround: "taxminan",
    dirShort: { protein: "O", fat: "Y", carbs: "U" },
    customTolerance: "Maqsaddan ±10% gacha farq qilish mumkin (kamida ±5 g) — shu oraliqda maqsadga erishilgan hisoblanadi.",
    premiumLockTitle: "Premiumda mavjud",
    premiumLockText: "Oqsil/yogʻ/uglevod maqsadlarini faqat Premiumda sozlash mumkin. Premiumsiz kunlik maqsadga erishganingiz faqat kaloriya boʻyicha aniqlanadi.",
    premiumLockTextSaved: "Oqsil/yogʻ/uglevod maqsadlaringiz saqlangan, ammo ularni oʻzgartirish uchun Premium kerak. Hozircha kunlik maqsadga erishganingiz faqat kaloriya boʻyicha aniqlanadi."
  },
  uk: {
    title: "Цілі по БЖВ",
